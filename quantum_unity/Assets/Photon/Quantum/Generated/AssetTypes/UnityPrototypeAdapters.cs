...
namespace Quantum.Prototypes.Unity {
  ...
  [Quantum.Prototypes.PrototypeAttribute(typeof(Quantum.Tank))]
  public class Tank_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.Tank_Prototype> {
    public Quantum.PlayerRef Player;
    public Photon.Deterministic.FP maxSpeed;
    public Photon.Deterministic.FP accelation;
    public Photon.Deterministic.FP braking;
    public Photon.Deterministic.FP rotationSpeed;
    public Photon.Deterministic.FP timeRespawn;
    public Photon.Deterministic.FP curTimeRespawn;
    [Quantum.LocalReference]
    public global::EntityPrototype visualTurret;
    public Photon.Deterministic.FP maxHealth;
    public Photon.Deterministic.FP currentHealth;

    public sealed override Quantum.Prototypes.Tank_Prototype Convert(EntityPrototypeConverter converter) {
      var result = new Quantum.Prototypes.Tank_Prototype();
      result.Player = this.Player;
      result.maxSpeed = this.maxSpeed;
      result.accelation = this.accelation;
      result.braking = this.braking;
      result.rotationSpeed = this.rotationSpeed;
      result.timeRespawn = this.timeRespawn;
      result.curTimeRespawn = this.curTimeRespawn;
      converter.Convert(this.visualTurret, out result.visualTurret);
  ...
  public class Weapon_Prototype : Quantum.PrototypeAdapter<Quantum.Prototypes.Weapon_Prototype> {
    public Quantum.PlayerRef Shell;
    public Photon.Deterministic.FP TimeToDesTroy;
    [Quantum.LocalReference]
    public global::EntityPrototype whoShell;
    public Photon.Deterministic.FP damage;
    ...
    public sealed override Quantum.Prototypes.Weapon_Prototype Convert(EntityPrototypeConverter converter) {
      ...
      converter.Convert(this.whoShell, out result.whoShell);
